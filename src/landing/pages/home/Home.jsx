...
const Home = () => {
  ...
  const handleBDAClick = () => {
    ...
    //   setIsModalOpen(false);
    //   dispatch(setShowSignInModal({ showSignInModal: true, redirectUrl: '/auction/bda-auction' }))
    // } else {
  ...
  // ✅ Modal timing: Show modal after 7 seconds only if not shown before in this session
  useEffect(() => {
    const hasModalBeenShown =
      sessionStorage.getItem(MODAL_SHOWN_KEY) === "true";
  ...
  // ✅ FIX 2: Improved modal scroll handling
  useEffect(() => {
    if (isModalOpen) {
  ...
  return (
    <>
      {/* ✅ FIX 1: Reduced z-index to stay below header */}

      {/* ✅ FIX 2: Improved Modal with 7-second delay and smooth animation (shows only once per session) */}
      {isModalOpen && (
        <div
        ...
        >
          <div className="flex justify-center items-start pt-60 px-4 sm:px-0 h-full overflow-y-auto">
            ...
            >
              ...
              />
              {/* <img src={modalback} alt="background image" className="absolute h-[250px] w-[250px] top-12 right-0" /> */}
              <div className="absolute top-14 left-6 pr-6">
                ...
                {/* <div className="text-white font-[Lato] text-[18px]">locations, recommendations and more</div> */}
                <button
            ...
            {/* ✅ Mobile View - Responsive for different screen sizes */}
            <div
            ...
            >
              ...
              <div className="mt-8 xs:mt-6 max-[350px]:mt-4">
                <div className="text-white font-[Lora] font-semibold text-[22px] xs:text-[20px] max-[350px]:text-[18px]">
                  Compare new launches near Bengaluru airport by Tata, Sattva
                  and others
                </div>
                {/* <div className="text-white font-[Lora] font-semibold text-[22px] xs:text-[20px] max-[350px]:text-[18px] mb-3 xs:mb-2 max-[350px]:mb-1">
                Tata, Sattva and others
                </div> */}
                <div className="text-white font-[Lato] text-[14px] xs:text-[13px] max-[350px]:text-[12px] pt-2">
                  Get the complete report now
                </div>
                {/* <div className="text-white font-[Lato] text-[14px] xs:text-[13px] max-[350px]:text-[12px] mb-4 xs:mb-3 max-[350px]:mb-2">
                  locations, recommendations and more.
                </div> */}
                <button
              ...
              {/* <div className="absolute bottom-8 xs:bottom-6 max-[350px]:bottom-4 right-0 sl:bottom-20 sr:bottom-16">
                <img 
                  src={back} 
                  alt="background" 
                  className="h-[130px] w-[130px] xs:h-[110px] xs:w-[110px] max-[350px]:h-[90px] max-[350px]:w-[90px]" 
                />
              </div> */}
